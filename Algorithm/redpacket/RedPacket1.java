...
public class RedPacket1 {
     ...
     * @return
     */
    public static List<BigDecimal> getAllHotPacket(double amountValue, double sizeValue, 
    		double maxMutValue, double sigmaValue) {
        //红包总金额
        ...
        do {
            ...
            for (int i = 0; i < hotPacketSize; i++) {
                BigDecimal randomBigDecimal = getRandomHotPacketAmount(mu.doubleValue(), 
                		sigma, restAmount, size.intValue()-1);
     ...
     * @return
     */
    private static BigDecimal getRandomHotPacketAmount(double mu, double sigma, 
    		BigDecimal rest, int restSize) {
        if(isMin){
            return MIN_VALUE;
        }
        BigDecimal radomNo;
    ...
    public static void main(String[] args) {
        ...
        List<BigDecimal> allHotPacket = getAllHotPacket(1000d, 10d, 3d, 1d);
